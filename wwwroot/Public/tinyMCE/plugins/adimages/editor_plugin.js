	...
	tinymce.create('tinymce.plugins.adimages',{
		init:function(ed,url){
			ed.addCommand('mceaddadimages',function(){
			    parent.windowsdig('批量添加图片', 'iframe:/master/filemanage/?maxselect=20&iframeid=&checkfrom=edit&filetype=img&fileinputid=&iframename=' + self.frameElement.getAttribute('name'), '900px', '480px', 'iframe');
				});
