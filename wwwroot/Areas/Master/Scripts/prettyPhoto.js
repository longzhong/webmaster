(function ($) {
    ...
    $.fn.prettyPhoto = function (pp_settings) {
        ...
        $.prettyPhoto.open = function () {
            ...
            $pp_pic_holder.find('.pp_description').show().html(unescape(pp_titles[set_position]));
                ...
                switch (_getFileType(pp_images[set_position])) {
                    case 'image':
                        ...
                        imgPreloader.onload = function () {
                            imgPreloader.width = imgPreloader.width < 300 ? 300 : imgPreloader.width;
        ...
        _showContent = function () {
            ...
            settings.animation_speed,
            function () {
                $pp_pic_holder.find('.pp_hoverContainer,#fullResImage').height(correctSizes['height']).width(correctSizes['width2']);
        ...
        function _buildOverlay(caller) {
            ...
            function (n, i) {
                if ($(n).attr('rel').indexOf(theRel) != -1) {
                    return ($(n).attr('alt')) ? $(n).attr('alt') : ""
                }
            }) : $.makeArray($(caller).attr('alt'));
