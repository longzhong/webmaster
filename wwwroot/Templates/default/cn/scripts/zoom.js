	...
	*/
	...
	jZoom.prototype = {
		init: function(id){
			...
			this.mImgSrc = this.magImg.getAttribute('_src').slice(0);//.slice(0,-4)
		...
		specFn: function(){
			...
			function TabFn(event){   
				...
				if (target.nodeName != "UL") { 
					...
					_oIBSrc = _oSpImg.getAttribute('_src'); 

					_is.magImg.setAttribute('src',_oISrc);
					_is.mImgSrc =  _oIBSrc.slice(0);  
				}
