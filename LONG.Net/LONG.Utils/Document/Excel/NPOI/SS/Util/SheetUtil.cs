...
namespace LONG.Utils.NPOI.SS.Util
{
    using System;
    ...
    public class SheetUtil
    {
         ...
         *  {@link LONG.Utils.NPOI.SS.UserModel.DataFormatter#formatCellValue(LONG.Utils.NPOI.SS.UserModel.Cell)}
        ...
        public static double GetColumnWidth(ISheet sheet, int column, bool useMergedCells)
        {
            ...
            using (Bitmap bmp = new Bitmap(2048, 100))
            {
                ...
                for (IEnumerator it = sheet.GetRowEnumerator(); it.MoveNext(); )
                {
                    ...
                    LONG.Utils.NPOI.SS.UserModel.IFont font1 = wb.GetFontAt(style.FontIndex);
