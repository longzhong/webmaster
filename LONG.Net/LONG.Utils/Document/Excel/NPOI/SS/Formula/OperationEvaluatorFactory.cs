...
namespace LONG.Utils.NPOI.SS.Formula
{
    ...
    using LONG.Utils.NPOI.SS.Formula.Functions;
    ...
    class OperationEvaluatorFactory
    {
        ...
        private static void Add(Hashtable m, OperationPtg ptgKey,
            LONG.Utils.NPOI.SS.Formula.Functions.Function instance)
        {
                ...
                OperationEvaluationContext ec)
        {
            ...
            LONG.Utils.NPOI.SS.Formula.Functions.Function result = _instancesByPtgClass[ptg] as LONG.Utils.NPOI.SS.Formula.Functions.Function;
            ...
            if (ptg is AbstractFunctionPtg)
            {
                ...
                {
                    case LONG.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_INDIRECT:
                        return Indirect.instance.Evaluate(args, ec);
                    case LONG.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_EXTERNAL:
