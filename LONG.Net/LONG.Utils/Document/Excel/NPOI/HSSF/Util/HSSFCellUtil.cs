...
namespace LONG.Utils.NPOI.HSSF.Util
{
    using System;
    using System.Collections;
    using LONG.Utils.NPOI.HSSF.UserModel;
    ...
    public class HSSFCellUtil
    {
        ...
        public static LONG.Utils.NPOI.SS.UserModel.IRow GetRow(int rowCounter, HSSFSheet sheet)
        {
            LONG.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowCounter);
            if (row == null)
            {
        ...
        public static LONG.Utils.NPOI.SS.UserModel.ICell GetCell(LONG.Utils.NPOI.SS.UserModel.IRow row, int column)
        {
            LONG.Utils.NPOI.SS.UserModel.ICell cell = row.GetCell(column);
        ...
        public static LONG.Utils.NPOI.SS.UserModel.ICell CreateCell(LONG.Utils.NPOI.SS.UserModel.IRow row, int column, String value, HSSFCellStyle style)
        {
            LONG.Utils.NPOI.SS.UserModel.ICell cell = GetCell(row, column);
        ...
        /// <param name="value">The value of the cell</param>
        /// <returns>A new HSSFCell.</returns>
        public static LONG.Utils.NPOI.SS.UserModel.ICell CreateCell(LONG.Utils.NPOI.SS.UserModel.IRow row, int column, String value)
        {
         ...
         */
        public static void SetCellStyleProperty(LONG.Utils.NPOI.SS.UserModel.ICell cell, HSSFWorkbook workbook, String propertyName, Object propertyValue)
        {
            LONG.Utils.NPOI.SS.UserModel.ICellStyle originalStyle = cell.CellStyle;
            LONG.Utils.NPOI.SS.UserModel.ICellStyle newStyle = null;
            ...
            {
                LONG.Utils.NPOI.SS.UserModel.ICellStyle wbStyle = workbook.GetCellStyleAt(i);
        ...
        private static Hashtable GetFormatProperties(LONG.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        private static void SetFormatProperties(
                LONG.Utils.NPOI.SS.UserModel.ICellStyle style, HSSFWorkbook workbook, Hashtable properties)
        {
            style.Alignment = (LONG.Utils.NPOI.SS.UserModel.HorizontalAlignment)GetShort(properties, ALIGNMENT);
            style.BorderBottom = (LONG.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_BOTTOM);
            style.BorderLeft = (LONG.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_LEFT);
            style.BorderRight = (LONG.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_RIGHT);
            style.BorderTop = (LONG.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_TOP);
            ...
            style.FillPattern = (LONG.Utils.NPOI.SS.UserModel.FillPatternType)GetShort(properties, FILL_PATTERN);
            ...
            style.VerticalAlignment = (LONG.Utils.NPOI.SS.UserModel.VerticalAlignment)GetShort(properties, VERTICAL_ALIGNMENT);
