...
namespace LONG.Utils.NPOI.HSSF.Util
{
    ...
    public class HSSFRegionUtil
    {
        ...
        private class CellPropertySetter
        {
            ...
            public void SetProperty(LONG.Utils.NPOI.SS.UserModel.IRow row, int column)
            {
                LONG.Utils.NPOI.SS.UserModel.ICell cell = HSSFCellUtil.GetCell(row, column);
        ...
        //[Obsolete]
        //public static void SetBorderLeft(LONG.Utils.NPOI.SS.UserModel.CellBorderType border, Region region, HSSFSheet sheet,
        ...
        public static void SetBorderLeft(LONG.Utils.NPOI.SS.UserModel.BorderStyle border, CellRangeAddress region, HSSFSheet sheet,
                HSSFWorkbook workbook)
        {
        ...
        //[Obsolete]
        //public static void SetBorderRight(LONG.Utils.NPOI.SS.UserModel.CellBorderType border, Region region, HSSFSheet sheet,
        //        HSSFWorkbook workbook)
        //{
        ...
        /// <param name="sheet">The sheet that the region is on.</param>
        /// <param name="workbook">The workbook that the region is on.</param>
        public static void SetBorderRight(LONG.Utils.NPOI.SS.UserModel.BorderStyle border, CellRangeAddress region, HSSFSheet sheet,
                HSSFWorkbook workbook)
        {
            int rowStart = region.FirstRow;
            int rowEnd = region.LastRow;
        ...
        //[Obsolete]
        //public static void SetBorderBottom(LONG.Utils.NPOI.SS.UserModel.CellBorderType border, Region region, HSSFSheet sheet,
        //        HSSFWorkbook workbook)
        //{
        ...
        /// <param name="sheet">The sheet that the region is on.</param>
        /// <param name="workbook">The workbook that the region is on.</param>
        public static void SetBorderBottom(LONG.Utils.NPOI.SS.UserModel.BorderStyle border, CellRangeAddress region, HSSFSheet sheet,
                HSSFWorkbook workbook)
        {
            ...
            LONG.Utils.NPOI.SS.UserModel.IRow row = HSSFCellUtil.GetRow(rowIndex, sheet);
        ...
        //[Obsolete]
        //public static void SetBorderTop(LONG.Utils.NPOI.SS.UserModel.CellBorderType border, Region region, HSSFSheet sheet,
        //        HSSFWorkbook workbook)
        //{
        ...
        /// <param name="sheet">The sheet that the region is on.</param>
        /// <param name="workbook">The workbook that the region is on.</param>
        public static void SetBorderTop(LONG.Utils.NPOI.SS.UserModel.BorderStyle border, CellRangeAddress region, HSSFSheet sheet,
                HSSFWorkbook workbook)
        {
            int colStart = region.FirstColumn;
            int colEnd = region.LastColumn;
