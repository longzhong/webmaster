...
namespace LONG.Utils.NPOI.HSSF.Extractor
{
    using System;
    using System.Text;
    using System.IO;
    ...
    using LONG.Utils.NPOI;
    using LONG.Utils.NPOI.HPSF;
    using LONG.Utils.NPOI.SS.Formula.Eval;
    using LONG.Utils.NPOI.HSSF.EventUserModel;
    ...
    public class EventBasedExcelExtractor : POIOLE2TextExtractor
    {
        ...
        private class TextListener : HSSFListener
        {
            ...
            private String FormatNumberDateCell(CellValueRecordInterface cell, double value)
            {
                ...
                {
                    // Is it a date?
                    if (LONG.Utils.NPOI.SS.UserModel.DateUtil.IsADateFormat(formatIndex, formatString) &&
                            LONG.Utils.NPOI.SS.UserModel.DateUtil.IsValidExcelDate(value))
                    {
                        ...
                        // Format as a date
                        DateTime d = LONG.Utils.NPOI.SS.UserModel.DateUtil.GetJavaDate(value, false);
