...
namespace LONG.Utils.NPOI.HSSF.Record
{
    using System;
    using System.Text;
    using LONG.Utils.NPOI.SS.Formula.Eval;
 ...
 */
    internal class SpecialCachedValue
    {
        ...
        public LONG.Utils.NPOI.SS.UserModel.CellType GetValueType()
        {
            int typeCode = GetTypeCode();
            switch (typeCode)
            {
                case STRING: return LONG.Utils.NPOI.SS.UserModel.CellType.STRING;
                case BOOLEAN: return LONG.Utils.NPOI.SS.UserModel.CellType.BOOLEAN;
                case ERROR_CODE: return LONG.Utils.NPOI.SS.UserModel.CellType.ERROR;
                case EMPTY: return LONG.Utils.NPOI.SS.UserModel.CellType.STRING; // is this correct?
            }
    ...
    public class FormulaRecord : CellRecord
    {
        ...
        [NonSerialized]
        private LONG.Utils.NPOI.SS.Formula.Formula field_8_parsed_expr;
...
*/
        ...
        {
            field_8_parsed_expr = LONG.Utils.NPOI.SS.Formula.Formula.Create(Ptg.EMPTY_PTG_ARRAY);
        }
        ...
        public FormulaRecord(RecordInputStream in1):base(in1)
        {
                ...
                field_8_parsed_expr = LONG.Utils.NPOI.SS.Formula.Formula.Read(field_7_expression_len, in1,in1.Available());
        }
        /**
 ...
 */
        ...
        {
            field_8_parsed_expr = LONG.Utils.NPOI.SS.Formula.Formula.Create(ptgs);
        }
        ...
        public Ptg[] ParsedExpression
        {
            ...
            set { field_8_parsed_expr = LONG.Utils.NPOI.SS.Formula.Formula.Create(value); }
        }
        public LONG.Utils.NPOI.SS.Formula.Formula Formula
        {
            get
            {
        ...
        public LONG.Utils.NPOI.SS.UserModel.CellType CachedResultType
        {
            get
            {
                if (specialCachedValue == null)
                {
                    return LONG.Utils.NPOI.SS.UserModel.CellType.NUMERIC;
                }
                return (LONG.Utils.NPOI.SS.UserModel.CellType)specialCachedValue.GetValueType();
            }
        }
