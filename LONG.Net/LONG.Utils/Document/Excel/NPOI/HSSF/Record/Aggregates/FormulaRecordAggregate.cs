...
namespace LONG.Utils.NPOI.HSSF.Record.Aggregates
{
 ...
 */
        ...
        public void SetArrayFormula(CellRangeAddress r, Ptg[] ptgs)
        {
            ...
            ArrayRecord arr = new ArrayRecord(LONG.Utils.NPOI.SS.Formula.Formula.Create(ptgs), new CellRangeAddress8Bit(r.FirstRow, r.LastRow, r.FirstColumn, r.LastColumn));
