...
namespace LONG.Utils.NPOI.HSSF.Record
{
    ...
    using LONG.Utils.NPOI.SS.Formula.Constant;
    ...
    public class ExternalNameRecord : StandardRecord
    {
        ...
        private LONG.Utils.NPOI.SS.Formula.Formula field_5_name_definition; // TODO - junits for name definition field
 ...
 */
        ...
        public ExternalNameRecord(RecordInputStream in1)
        {
            ...
            //nBytesRemaining -= 2;
            //field_5_name_definition = LONG.Utils.NPOI.SS.Formula.Formula.Read(formulaLen, in1, nBytesRemaining);
        }
