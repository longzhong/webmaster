...
namespace LONG.Utils.NPOI.HSSF.Record
{
    ...
    public class DVRecord : StandardRecord
    {
        ...
        private LONG.Utils.NPOI.SS.Formula.Formula _formula1;
        ...
        private LONG.Utils.NPOI.SS.Formula.Formula _formula2;
            ...
            CellRangeAddressList regions)
        {
            ...
            _formula1 = LONG.Utils.NPOI.SS.Formula.Formula.Create(formula1);
            _formula2 = LONG.Utils.NPOI.SS.Formula.Formula.Create(formula2);
            _regions = regions;
        }
        ...
        public DVRecord(RecordInputStream in1)
        {
            ...
            _formula1 = LONG.Utils.NPOI.SS.Formula.Formula.Read(field_size_first_formula, in1);

            int field_size_sec_formula = in1.ReadUShort();
            _not_used_2 = in1.ReadShort();

            //read sec formula data condition
            _formula2 = LONG.Utils.NPOI.SS.Formula.Formula.Read(field_size_sec_formula, in1);
