...
namespace LONG.Utils.NPOI.HSSF.Record
{
    ...
    public class ArrayRecord : SharedValueRecordBase
    {
        ...
        private LONG.Utils.NPOI.SS.Formula.Formula _formula;
            ...
            : base(in1)
        {
		    ...
		    _formula = LONG.Utils.NPOI.SS.Formula.Formula.Read(formulaTokenLen, in1, totalFormulaLen);
        }
        public ArrayRecord(LONG.Utils.NPOI.SS.Formula.Formula formula, CellRangeAddress8Bit range):base(range)
        {
