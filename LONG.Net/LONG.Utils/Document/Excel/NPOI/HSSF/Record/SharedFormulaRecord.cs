...
namespace LONG.Utils.NPOI.HSSF.Record
{
    ...
    public class SharedFormulaRecord : SharedValueRecordBase
    {
        ...
        private LONG.Utils.NPOI.SS.Formula.Formula field_7_parsed_expr;

        public SharedFormulaRecord()
            : this(new CellRangeAddress8Bit(0, 0, 0, 0))
        {
            //field_7_parsed_expr = LONG.Utils.NPOI.SS.Formula.Formula.Create(Ptg.EMPTY_PTG_ARRAY);
        }
            ...
            : base(in1)
        {
            ...
            field_7_parsed_expr = LONG.Utils.NPOI.SS.Formula.Formula.Read(field_6_expression_len, in1, nAvailableBytes);
        }
