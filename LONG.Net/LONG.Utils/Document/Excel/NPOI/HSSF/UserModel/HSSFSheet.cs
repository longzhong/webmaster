...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    using LONG.Utils.NPOI.HSSF.Model;
    using LONG.Utils.NPOI.HSSF.Record;
    using LONG.Utils.NPOI.HSSF.Record.Aggregates;
    using LONG.Utils.NPOI.HSSF.Record.AutoFilter;
    using LONG.Utils.NPOI.HSSF.Util;
    using LONG.Utils.NPOI.SS;
    using LONG.Utils.NPOI.SS.Formula;
    using LONG.Utils.NPOI.SS.Formula.PTG;
    using LONG.Utils.NPOI.SS.UserModel;
    using LONG.Utils.NPOI.SS.Util;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : LONG.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, LONG.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="LONG.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, LONG.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="LONG.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(LONG.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public LONG.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            LONG.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public LONG.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(LONG.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(LONG.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public LONG.Utils.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    LONG.Utils.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new LONG.Utils.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="LONG.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public LONG.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, LONG.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, LONG.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, LONG.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, LONG.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, LONG.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                LONG.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                LONG.Utils.NPOI.SS.Util.CellRangeAddress region = (LONG.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(LONG.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    LONG.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, LONG.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, LONG.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public LONG.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(LONG.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(LONG.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, LONG.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                LONG.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public LONG.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                LONG.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
