...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    public class DVConstraint : IDataValidationConstraint
    {
         ...
         * 
         * @param validationType one of {@link LONG.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#ANY},
         * {@link LONG.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#DECIMAL},
         * {@link LONG.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#INTEGER},
         * {@link LONG.Utils.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#TEXT_LENGTH}
         * @param comparisonOperator any constant from {@link LONG.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
         ...
         * 
         * @param comparisonOperator constant from {@link LONG.Utils.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
        ...
        /* (non-Javadoc)
         * @see LONG.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getValidationType()
         */
        ...
        /* (non-Javadoc)
         * @see LONG.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula1()
         */
        ...
        /* (non-Javadoc)
         * @see LONG.Utils.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula2()
         */
