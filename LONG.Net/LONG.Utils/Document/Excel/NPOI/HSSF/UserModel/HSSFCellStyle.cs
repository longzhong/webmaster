...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFCellStyle : ICellStyle
    {
        ...
        private LONG.Utils.NPOI.HSSF.Model.InternalWorkbook workbook = null;
        ...
        /// <param name="rec">The record.</param>
        /// <param name="workbook">The workbook.</param>
        public HSSFCellStyle(short index, ExtendedFormatRecord rec, LONG.Utils.NPOI.HSSF.Model.InternalWorkbook workbook)
        {
        ...
        /// <param name="workbook">The workbook.</param>
        /// <returns></returns>
        public String GetDataFormatString(LONG.Utils.NPOI.HSSF.Model.InternalWorkbook workbook)
        {
            HSSFDataFormat format = new HSSFDataFormat(workbook);
        ...
        public void SetFont(LONG.Utils.NPOI.SS.UserModel.IFont font)
        {
