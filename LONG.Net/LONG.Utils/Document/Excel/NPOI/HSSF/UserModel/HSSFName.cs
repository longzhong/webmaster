...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:LONG.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, LONG.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
