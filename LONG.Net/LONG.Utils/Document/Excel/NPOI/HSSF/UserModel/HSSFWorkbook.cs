...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    using LONG.Utils.NPOI.POIFS.FileSystem;
    using LONG.Utils.NPOI.SS.Formula;
    using LONG.Utils.NPOI.SS.Formula.PTG;
    using LONG.Utils.NPOI.SS.Formula.Udf;
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public LONG.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : LONG.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private LONG.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = LONG.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public LONG.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            LONG.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public LONG.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public LONG.Utils.NPOI.SS.UserModel.Font FindFont(LONG.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 LONG.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, LONG.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public LONG.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                LONG.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public LONG.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public LONG.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public LONG.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, LONG.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case LONG.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case LONG.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case LONG.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case LONG.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case LONG.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case LONG.Utils.NPOI.SS.UserModel.PictureType.DIB:
