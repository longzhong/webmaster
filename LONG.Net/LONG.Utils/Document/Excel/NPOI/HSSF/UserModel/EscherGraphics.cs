...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    public class EscherGraphics : IDisposable
    {
        ...
        private HSSFFont MatchFont(Font font)
        {
            ...
            HSSFFont hssfFont = (HSSFFont)workbook.FindFont(bold ? (short)LONG.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : (short)LONG.Utils.NPOI.SS.UserModel.FontBoldWeight.NORMAL,
                        hssfColor.GetIndex(),
                        (short)(font.Size * 20),
                        font.Name,
                        italic,
                        false,
                        (short)LONG.Utils.NPOI.SS.UserModel.FontSuperScript.NONE,
                        (byte)LONG.Utils.NPOI.SS.UserModel.FontUnderlineType.NONE
                        );
            if (hssfFont == null)
            {
                hssfFont = (HSSFFont)workbook.CreateFont();
                hssfFont.Boldweight = (short)(bold ? LONG.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : 0);
