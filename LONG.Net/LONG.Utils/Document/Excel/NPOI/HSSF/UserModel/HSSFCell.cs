 ...
 */
        ...
        public void SetCellValue(IRichTextString value)
        {
            ...
            if (hvalue.Length > LONG.Utils.NPOI.SS.SpreadsheetVersion.EXCEL97.MaxTextLength)
            {
 ...
 */
        ...
        public override String ToString()
        {
            switch (CellType)
            {
                ...
                case CellType.ERROR:
                    return LONG.Utils.NPOI.SS.Formula.Eval.ErrorEval.GetText(((BoolErrRecord)record).ErrorValue);
                case CellType.FORMULA:
                    return CellFormula;
                case CellType.NUMERIC:
