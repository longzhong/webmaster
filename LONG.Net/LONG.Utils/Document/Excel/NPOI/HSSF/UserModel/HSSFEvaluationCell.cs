...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationCell : IEvaluationCell
    {
        ...
        private LONG.Utils.NPOI.SS.UserModel.ICell _cell;

        public HSSFEvaluationCell(LONG.Utils.NPOI.SS.UserModel.ICell cell, IEvaluationSheet evalSheet)
        {
            _cell = cell;
            _evalSheet = evalSheet;
        }
        public HSSFEvaluationCell(LONG.Utils.NPOI.SS.UserModel.ICell cell)
        {
            _cell = cell;
        ...
        {
            LONG.Utils.NPOI.SS.UserModel.ICell cellb = ((HSSFEvaluationCell)obj)._cell;
        ...
        public LONG.Utils.NPOI.SS.UserModel.ICell HSSFCell
        {
            get
            {
                return _cell;
        ...
        public LONG.Utils.NPOI.SS.UserModel.CellType CellType
        {
            get
            {
