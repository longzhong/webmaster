...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    public class HSSFAutoFilter : IAutoFilter
    {
        ...
        private void CreateFilterModeRecord(HSSFSheet sheet,int insertPos)
        {
            ...
            LONG.Utils.NPOI.HSSF.Record.Record record = sheet.Sheet.FindFirstRecordBySid(FilterModeRecord.sid);
        ...
        private void CreateAutoFilterInfoRecord(HSSFSheet sheet, int insertPos, Area3DPtg ptg)
        {
            ...
            LONG.Utils.NPOI.HSSF.Record.Record record = sheet.Sheet.FindFirstRecordBySid(AutoFilterInfoRecord.sid);
