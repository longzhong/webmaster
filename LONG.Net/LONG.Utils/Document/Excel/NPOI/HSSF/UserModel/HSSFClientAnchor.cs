...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFClientAnchor : HSSFAnchor, LONG.Utils.NPOI.SS.UserModel.IClientAnchor
    {
        int col1;
        int row1;
        int col2;
        ...
        public float GetAnchorHeightInPoints(LONG.Utils.NPOI.SS.UserModel.ISheet sheet)
        {
            int y1 = Dy1;
            int y2 = Dy2;
        ...
        /// <returns></returns>
        private float GetRowHeightInPoints(LONG.Utils.NPOI.SS.UserModel.ISheet sheet, int rowNum)
        {
            LONG.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowNum);
            if (row == null)
