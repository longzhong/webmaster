...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFPrintSetup :LONG.Utils.NPOI.SS.UserModel.IPrintSetup
    {
        ...
        public LONG.Utils.NPOI.SS.UserModel.DisplayCellErrorType CellError
        {
            get { return (LONG.Utils.NPOI.SS.UserModel.DisplayCellErrorType)printSetupRecord.CellError; }
