...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFCreationHelper : ICreationHelper
    {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IRichTextString CreateRichTextString(String text)
        {
        ...
        public LONG.Utils.NPOI.SS.UserModel.IHyperlink CreateHyperlink(HyperlinkType type)
        {
         ...
         */
        public LONG.Utils.NPOI.SS.UserModel.IFormulaEvaluator CreateFormulaEvaluator()
        {
         ...
         * @see LONG.Utils.NPOI.SS.usermodel.Drawing
         */
        public LONG.Utils.NPOI.SS.UserModel.IClientAnchor CreateClientAnchor()
        {
