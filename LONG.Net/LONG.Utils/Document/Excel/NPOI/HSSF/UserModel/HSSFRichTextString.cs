...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,LONG.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, LONG.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(LONG.Utils.NPOI.SS.UserModel.IFont font)
        {
