...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFOptimiser
    {
        ...
        public static void OptimiseFonts(HSSFWorkbook workbook)
        {
            ...
            {
                LONG.Utils.NPOI.SS.UserModel.ISheet s = workbook.GetSheetAt(sheetNum);
                ...
                while (rIt.MoveNext())
                {
                    ...
                    while (cIt.MoveNext())
                    {
                        ...
                        if (cell.CellType == LONG.Utils.NPOI.SS.UserModel.CellType.STRING)
                        {
            ...
            for (int sheetNum = 0; sheetNum < workbook.NumberOfSheets; sheetNum++)
            {
                ...
                while (rIt.MoveNext())
                {
                    ...
                    while (cIt.MoveNext())
                    {
                        ...
                        LONG.Utils.NPOI.SS.UserModel.ICellStyle newStyle = workbook.GetCellStyleAt(
                                newPos[oldXf]
                        );
