...
namespace LONG.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    [Serializable]
    public class HSSFTextbox : HSSFSimpleShape //,LONG.Utils.NPOI.SS.UserModel.ITextbox
    {
    ...
    public static short  VERTICAL_ALIGNMENT_DISTRIBUTED= 7;
        ...
        LONG.Utils.NPOI.SS.UserModel.IRichTextString str = new HSSFRichTextString("");
        ...
        public virtual LONG.Utils.NPOI.SS.UserModel.IRichTextString String
        {
            get { return str; }
            set
