...
namespace LONG.Utils.EPPlus.Style
{
    ...
    public abstract class StyleBase
    {
        ...
        internal LONG.Utils.EPPlus.XmlHelper.ChangedEventHandler _ChangedEvent;
        protected int _positionID;
        protected string _address;
        internal StyleBase(ExcelStyles styles, LONG.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string Address)
        {
            _styles = styles;
