...
using LONG.Utils.EPPlus.Utils;
using System.Xml;
using LONG.Utils.EPPlus.DataValidation.Contracts;

namespace LONG.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit LONG.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
