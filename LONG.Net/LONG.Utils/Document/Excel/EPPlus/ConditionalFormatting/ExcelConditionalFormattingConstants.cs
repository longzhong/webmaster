...
namespace LONG.Utils.EPPlus.ConditionalFormatting
{
  /// <summary>
  ...
  internal static class ExcelConditionalFormattingConstants
  {
    ...
    internal class Errors
    {
      ...
      internal const string InvalidCfruleObject = @"The supplied item must inherit LONG.Utils.EPPlus.ConditionalFormatting.ExcelConditionalFormattingRule";
      internal const string InvalidConditionalFormattingObject = @"The supplied item must inherit LONG.Utils.EPPlus.ConditionalFormatting.ExcelConditionalFormatting";
