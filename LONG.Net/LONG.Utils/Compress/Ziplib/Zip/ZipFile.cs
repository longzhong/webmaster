...
using LONG.Utils.ZipLib.Encryption;
#endif

using LONG.Utils.ZipLib.Core;
using LONG.Utils.ZipLib.Checksums;
using LONG.Utils.ZipLib.Zip.Compression.Streams;
using LONG.Utils.ZipLib.Zip.Compression;

namespace LONG.Utils.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="LONG.Utils.ZipLib.Zip.ZipException">
