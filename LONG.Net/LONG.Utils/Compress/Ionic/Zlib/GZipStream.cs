...
namespace LONG.Utils.Ionic.Zlib
{
    ...
    ///   <c>LONG.Utils.Ionic.Zlib.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new LONG.Utils.Ionic.Zlib.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new LONG.Utils.Ionic.Zlib.GZipStream(input, CompressionMode.Decompress, True)
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == LONG.Utils.Ionic.Zlib.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == LONG.Utils.Ionic.Zlib.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == LONG.Utils.Ionic.Zlib.ZlibBaseStream.StreamMode.Undefined)
            {
