...
namespace LONG.Utils.Ionic
{
    ...
    ///   cref="LONG.Utils.Ionic.Zip.ZipFile.AddSelectedFiles(String,String)"/> method, or one of
    ///   its overloads, is called.  It's also used for the <see
    ///   cref="LONG.Utils.Ionic.Zip.ZipFile.ExtractSelectedEntries(String)"/> methods.  Typically, an
