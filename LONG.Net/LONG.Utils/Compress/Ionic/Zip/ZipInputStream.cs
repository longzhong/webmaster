...
// reading zip files.  This class does not depend on LONG.Utils.Ionic.Zip.ZipFile, but rather
    ...
    public class ZipInputStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_LeftToRead == 0)
            {
                ...
                // workitem 10178
                LONG.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(_inputStream);
            }
        ...
        private LONG.Utils.Ionic.Crc.CrcCalculatorStream _crcStream;
