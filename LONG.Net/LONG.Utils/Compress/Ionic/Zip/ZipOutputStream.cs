...
// generating zip files.  This class does not depend on LONG.Utils.Ionic.Zip.ZipFile, but rather
...
namespace LONG.Utils.Ionic.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = LONG.Utils.Ionic.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="LONG.Utils.Ionic.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = LONG.Utils.Ionic.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="LONG.Utils.Ionic.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private LONG.Utils.Ionic.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public LONG.Utils.Ionic.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
