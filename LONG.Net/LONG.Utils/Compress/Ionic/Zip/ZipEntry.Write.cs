...
namespace LONG.Utils.Ionic.Zip
{
    public partial class ZipEntry
    {
...
#if BZIP
            if (this.CompressionMethod == LONG.Utils.Ionic.Zip.CompressionMethod.BZip2)
        ...
        private bool WantReadAgain()
        {
            ...
            if (CompressionLevel == LONG.Utils.Ionic.Zlib.CompressionLevel.None) return false;
        ...
        private void MaybeUnsetCompressionMethodForWriting(int cycle)
        {
            ...
            if (CompressionLevel == (short)LONG.Utils.Ionic.Zlib.CompressionLevel.None &&
                CompressionMethod == LONG.Utils.Ionic.Zip.CompressionMethod.Deflate)
                _CompressionMethod = 0x00;
        ...
        internal void WriteHeader(Stream s, int cycle)
        {
            ...
            // LastMod
            _TimeBlob = LONG.Utils.Ionic.Zip.SharedUtilities.DateTimeToPacked(LastModified);
        ...
        private Int32 FigureCrc32()
        {
            if (_crcCalculated == false)
            {
                ...
                {
                    var output = new LONG.Utils.Ionic.Crc.CrcCalculatorStream(Stream.Null);
                ...
                else
                {
                    ...
                    var crc32 = new LONG.Utils.Ionic.Crc.CRC32();
        ...
        private void _WriteEntryData(Stream s)
        {
            ...
            try
            {
                ...
                var output = new LONG.Utils.Ionic.Crc.CrcCalculatorStream(compressor, true);
        ...
        internal void FinishOutputStream(Stream s,
                                         ...
                                         Stream encryptor,
                                         Stream compressor,
                                         LONG.Utils.Ionic.Crc.CrcCalculatorStream output)
        {
            ...
            if ((compressor as LONG.Utils.Ionic.Zlib.DeflateStream) != null)
                compressor.Close();
#if BZIP
            else if ((compressor as LONG.Utils.Ionic.BZip2.BZip2OutputStream) != null)
                compressor.Close();
#if !NETCF
            else if ((compressor as LONG.Utils.Ionic.BZip2.ParallelBZip2OutputStream) != null)
                compressor.Close();
#endif
#endif

#if !NETCF
            else if ((compressor as LONG.Utils.Ionic.Zlib.ParallelDeflateOutputStream) != null)
                compressor.Close();
#endif
            ...
            if (_UncompressedSize == 0 && _CompressedSize == 0)
            {
                ...
                if (_Password != null)
                {
                    ...
                    if (Encryption != EncryptionAlgorithm.None)
                    {
                        ...
                        // workitem 10178
                        LONG.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(s);
        ...
        internal void PrepOutputStream(Stream s,
                                       ...
                                       out LONG.Utils.Ionic.Crc.CrcCalculatorStream output)
        {
            ...
            // Wrap a CrcCalculatorStream around that.
            // This will happen BEFORE compression (if any) as we write data out.
            output = new LONG.Utils.Ionic.Crc.CrcCalculatorStream(compressor, true);
        }
        ...
        {
            if (_CompressionMethod == 0x08 && CompressionLevel != LONG.Utils.Ionic.Zlib.CompressionLevel.None)
            {
#if !NETCF
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    if (_container.ParallelDeflater == null)
                    {
                        _container.ParallelDeflater =
                            new LONG.Utils.Ionic.Zlib.ParallelDeflateOutputStream(s,
                                                                       CompressionLevel,
                                                                       _container.Strategy,
                                                                       true);
                    ...
                    LONG.Utils.Ionic.Zlib.ParallelDeflateOutputStream o1 = _container.ParallelDeflater;
                    o1.Reset(s);
                    return o1;
                }
#endif
                var o = new LONG.Utils.Ionic.Zlib.DeflateStream(s, LONG.Utils.Ionic.Zlib.CompressionMode.Compress,
                                                     CompressionLevel,
                                                     true);
                if (_container.CodecBufferSize > 0)
            ...
            if (_CompressionMethod == 0x0c)
            {
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    var o1 = new LONG.Utils.Ionic.BZip2.ParallelBZip2OutputStream(s, true);
                    return o1;
                }
#endif
                var o = new LONG.Utils.Ionic.BZip2.BZip2OutputStream(s, true);
                return o;
            }
#endif
