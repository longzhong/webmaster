...
namespace LONG.Utils.Ionic.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="LONG.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="LONG.Utils.Ionic.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="LONG.Utils.Ionic.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        ///   using (LONG.Utils.Ionic.Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As LONG.Utils.Ionic.Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public LONG.Utils.Ionic.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public LONG.Utils.Ionic.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal LONG.Utils.Ionic.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new LONG.Utils.Ionic.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        internal void CalcWinZipAesMac(Stream input)
        {
                ...
                Encryption == EncryptionAlgorithm.WinZipAes256)
            {
                ...
                else if (input is LONG.Utils.Ionic.Zlib.CrcCalculatorStream)
                {
                    xxx;
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                LONG.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new LONG.Utils.Ionic.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new LONG.Utils.Ionic.Zlib.DeflateStream(input2, LONG.Utils.Ionic.Zlib.CompressionMode.Decompress, true);
#if BZIP
                case (short)CompressionMethod.BZip2:
                    return new LONG.Utils.Ionic.BZip2.BZip2InputStream(input2, true);
#endif
            }
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = LONG.Utils.Ionic.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
