...
namespace LONG.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            LONG.Utils.Ionic.FileSelector ff = new LONG.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace LONG.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(LONG.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(LONG.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(LONG.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<LONG.Utils.Ionic.Zip.ZipEntry> SelectEntries(LONG.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<LONG.Utils.Ionic.Zip.ZipEntry>();

            foreach (LONG.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<LONG.Utils.Ionic.Zip.ZipEntry> SelectEntries(LONG.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
