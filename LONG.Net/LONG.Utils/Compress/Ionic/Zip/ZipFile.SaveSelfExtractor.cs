...
namespace LONG.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public LONG.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "LONG.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "LONG.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "LONG.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace LONG.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the LONG.Utils.Ionic.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  LONG.Utils.Ionic.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("LONG.Utils.Ionic.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the LONG.Utils.Ionic.Zip
                        ...
                        // add the LONG.Utils.Ionic.Utils.Zip DLL as an embedded resource
