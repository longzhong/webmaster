...
namespace LONG.Utils.Ionic.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = LONG.Utils.Ionic.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = LONG.Utils.Ionic.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)LONG.Utils.Ionic.Zip.CompressionMethod.None)
                    _CompressionLevel = LONG.Utils.Ionic.Zlib.CompressionLevel.None;
                else if (CompressionLevel == LONG.Utils.Ionic.Zlib.CompressionLevel.None)
                    _CompressionLevel = LONG.Utils.Ionic.Zlib.CompressionLevel.Default;
        ...
        public LONG.Utils.Ionic.Zlib.CompressionLevel CompressionLevel
        {
            ...
            set
            {
                ...
                if (value == LONG.Utils.Ionic.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == LONG.Utils.Ionic.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == LONG.Utils.Ionic.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) LONG.Utils.Ionic.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short) LONG.Utils.Ionic.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </example>
        ///
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipEntry.Encryption"/>
        ...
        ///
        /// </remarks>
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="LONG.Utils.Ionic.Zip.ZipFile.ZipErrorAction"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = LONG.Utils.Ionic.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new LONG.Utils.Ionic.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new LONG.Utils.Ionic.Zip.ZipException("The filename must be non-null and non-empty.");
...
#if NETCF
                    // workitem 6878
                    // LONG.Utils.Ionic.Zip.SharedUtilities.AdjustTime_Win32ToDotNet
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                LONG.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private LONG.Utils.Ionic.Zlib.CompressionLevel _CompressionLevel;
