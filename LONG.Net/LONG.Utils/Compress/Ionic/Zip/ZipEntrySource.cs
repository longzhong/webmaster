...
namespace LONG.Utils.Ionic.Zip
{
    ...
    public enum ZipEntrySource
    {
        ...
        /// <summary>
        /// The entry was instantiated via <see cref="LONG.Utils.Ionic.Zip.ZipFile.AddEntry(string,string)"/> or
        /// <see cref="LONG.Utils.Ionic.Zip.ZipFile.AddEntry(string,System.IO.Stream)"/> .
        /// </summary>
        Stream,
        ...
        /// The entry was instantiated via <see cref="LONG.Utils.Ionic.Zip.ZipFile.AddEntry(string,OpenDelegate,CloseDelegate)"/>.
        /// </summary>
        JitStream,
