...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:LONG.Utils.Ionic.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace LONG.Utils.Ionic.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly LONG.Utils.Ionic.Crc.CRC32 crc = new LONG.Utils.Ionic.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new LONG.Utils.Ionic.BZip2.BZip2InputStream(fs))
        ///       {
