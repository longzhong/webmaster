...
namespace LONG.Utils.Ionic.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="LONG.Utils.Ionic.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="LONG.Utils.Ionic.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new LONG.Utils.Ionic.BZip2.ParallelBZip2OutputStream(output))
        ///           {
