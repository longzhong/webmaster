...
namespace LONG.Core
{
    public class APP
    {
        ...
        //BLL的一些设置
        public static string SERVICE_BLL_NAMESPACE = "LONG.Models"; //指定bll层的命名空间
        public static string SERVICE_BLL_FILE_NAME = "LONG.Web"; //指定bll层所在的dll名称，如LONG.BLL.dll 则值为LONG.BLL
